...
<%
  // TableDataPager.ascx
  // Implementation of the TableDataPager Control.
  ...
  // 26.04.2006 minor layour changes.
%>
...
<script runat="server">
  ...
  protected override void OnPreRender(EventArgs e) {
    ...
    if (!Page.ClientScript.IsClientScriptBlockRegistered(this.GetType(), "MyBehaviour")) {
      ...
      ((HtmlHead)Page.Header).Controls.Add(new LiteralControl("<script type='text/javascript' src='"
        + Page.ResolveUrl("~/controls/tabledatapager.js")
        + "'><" + "/script>\n"));
    } // if
  } // OnPreRender
</script>
...
<div id="<%=this.ClientID %>" class="TableDataPager" pagesize="<%=this.pagesize %>" service="<%=this.service %>" tabledatapart="<%=this.tabledatapart%>">
  <a style="width:24px;" href="nav:first">|&lt;</a>
  <a style="width:24px;" href="nav:prev">&lt;&lt;</a>
  <a>1</a> <a>2</a> <a>3</a> <a>4</a> <a>5</a>
  <a style="width:24px;" href="nav:next">&gt;&gt;</a>
  <a style="width:24px;" href="nav:last">&gt;|</a>
  <% if (Showall) { %>
  <a style="width:24px; padding-left: 10px" href="nav:all">(all)</a>
  <% } %>
</div>


<script type="text/javascript">
jcl.LoadBehaviour("<%=this.ClientID %>", TableDataPagerBehaviour);
</script>
